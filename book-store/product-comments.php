...
<body>
 ...
 if(isset($_POST['comment']) && !empty($_POST['comment'])){
	 $comment=$_POST['comment'];
		$sql="insert into comments(product_id,comment) values ('$pro_id','$comment')";
		$run=mysql_query($sql);
	 //save to database
	 header( "refresh:2;url=product-details.php?pro_id=$pro_id" );
	 echo "<h1 id='hea'>COMMENT SUBMITTED</h1>";
 }
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					...
					<form action='product-comments.php?pro_id=<?php echo $pro_id ?>' method='POST'>
